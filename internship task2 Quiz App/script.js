...
//             let findQuestion=questions[qno-1];
//             let {client_answers}=clientAnswers[i];
//             let isFirstOptionCorrect=(findQuestion.client_answers.answer_a_correct==="true") && (client_answers.isOption1Correct===true);
//             let isSecondOptionCorrect=(findQuestion.client_answers.answer_b_correct==="true") && (client_answers.isOption2Correct===true);
//             let isThirdOptionCorrect=(findQuestion.client_answers.answer_c_correct==="true") && (client_answers.isOption3Correct===true);
//             let isFourthOptionCorrect=(findQuestion.client_answers.answer_d_correct==="true") && (client_answers.isOption4Correct===true);
//             if(isFirstOptionCorrect || isSecondOptionCorrect || isThirdOptionCorrect || isFourthOptionCorrect){
//                 correctAnswers++;
//             }
//             else{
...
//             <input type="radio" onchange="checkQuestion()" ${(isPreviousAnsw)?(clientAnswers[clientAnswerInd].client_answers.isOption1Correct)?"checked":null:null} id="option1" value="${questions[start].answers.answer_a}" name="eachOptionInput">
//             <label for="option1" id="label1">${questions[start].answers.answer_a}</label>
//         </div>
//         <div class="eachOption">
//             <input type="radio" id="option2" onchange="checkQuestion()" ${(isPreviousAnsw)?(clientAnswers[clientAnswerInd].client_answers.isOption2Correct)?"checked":null:null} value="${questions[start].answers.answer_b}" name="eachOptionInput">
//             <label for="option2" id="label2">${questions[start].answers.answer_b}</label>
//         </div>
//         ${(questions[start].answers.answer_c !== null) ? `
//             <div class="eachOption">
//                <input type="radio" id="option3" onchange="checkQuestion()" ${(isPreviousAnsw)?(clientAnswers[clientAnswerInd].client_answers.isOption3Correct)?"checked":null:null} value="${questions[start].answers.answer_c}" name="eachOptionInput">
//                <label for="option3" id="label3">${questions[start].answers.answer_c}</label>
//            </div>`: ""
//         }
//         ${(questions[start].answers.answer_d !== null) ? `
//             <div class="eachOption">
//                 <input type="radio" id="option4" onchange="checkQuestion()" ${(isPreviousAnsw)?(clientAnswers[clientAnswerInd].client_answers.isOption4Correct)?"checked":null:null} value="${questions[start].answers.answer_d}" name="eachOptionInput">
